...
var expectedGetClusterResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		...
		CNIType: cluster.CNITypeCilium,
	},
	CNICiliumSettings: &cluster.CNICiliumSettings{
		EnvoyDaemonset: testutils.BoolToPtr(true),
		HubbleRelay:    testutils.BoolToPtr(true),
	},
}
...
var expectedGetZonalClusterResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		ID:                            "763f1f5f-951e-48b2-abae-815a75ee747c",
		CreatedAt:                     &clusterResponseTimestamp,
		UpdatedAt:                     &clusterResponseTimestamp,
...
var expectedListClustersResponse = []*cluster.ListView{
	{
		BaseView: cluster.BaseView{
			ID:                            "dbe7559b-55d8-4f65-9230-6a22b985ff73",
			CreatedAt:                     &clusterResponseTimestamp,
...
var expectedCreateClusterResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		ID:                            "1f4dfa6a-0468-45e0-be13-74c6481820f5",
		CreatedAt:                     &clusterResponseTimestamp,
		UpdatedAt:                     nil,
...
// with disabled booleans opts.
var expectedCreateClusterDisableBoolsResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		ID:                            "1f4dfa6a-0468-45e0-be13-74c6481820f5",
		CreatedAt:                     &clusterResponseTimestamp,
		UpdatedAt:                     nil,
...
var expectedCreateZonalClusterResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		ID:                            "effe751d-501a-4b06-8e23-3f686dbfccf6",
		CreatedAt:                     &clusterResponseTimestamp,
		UpdatedAt:                     nil,
...
var expectedCreatePrivateKubeAPIClusterResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		ID:                            "effe751d-501a-4b06-8e23-3f686dbfccf6",
		CreatedAt:                     &clusterResponseTimestamp,
		UpdatedAt:                     nil,
...
var expectedUpdateClusterWithEnabledPSPResponse = &cluster.GetView{
	BaseView: cluster.BaseView{
		ID:                            "effe751d-501a-4b06-8e23-3f686dbfccf6",
		CreatedAt:                     &clusterResponseTimestamp,
		UpdatedAt:                     nil,
